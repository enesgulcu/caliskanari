...
const NewSystemDataProcess = async (
    ...
    apiUrl: string = + "/" + "other" + "/" + componentName // veri tabanı api adresi
...
//2.2 #### COOKIE KONTROLÜ VE İŞLEMLERİ ##########################################################################
            ...
            let checkCookie:string | undefined | null | boolean = getCookie(componentName)
...
//2.3 #### LOCALSTORAGE KONTROLÜ VE İŞLEMLERİ ####################################################################
            ...
            const checkLocalStor:string | null = localStorage.getItem(componentName);
